riot.tag("weather", '<div class="w-header"> <span class="y-icon icon-location" onclick="{changeLocation}" ga_event="mh_change_city">&nbsp;{options.city}</span> <span class="wind">{options.wind}</span> <span class="air" riot-style="background: {options.level}">{options.air}</span> </div> <ul class="y-box days-weather {show: options.weather_show}"> <li class="y-left day"> <span class="title">今天</span> <div title="{options.weather.current_condition}" class="weather-icon weather-icon-{options.weather.weather_icon_id}"></div> <span class="temperature"> <em>{options.weather.low_temperature}</em>&#176; &#47; <em>{options.weather.high_temperature}</em>&#176; </span> </li> <li class="y-left day"> <span class="title">明天</span> <div title="{options.weather.tomorrow_condition}" class="weather-icon weather-icon-{options.weather.tomorrow_weather_icon_id}"></div> <span class="temperature"> <em>{options.weather.tomorrow_low_temperature}</em>&#176; &#47; <em>{options.weather.tomorrow_high_temperature}</em>&#176; </span> </li> <li class="y-left day"> <span class="title">后天</span> <div title="{options.weather.dat_condition}" class="weather-icon weather-icon-{options.weather.dat_weather_icon_id}"></div> <span class="temperature"> <em>{options.weather.dat_low_temperature}</em>&#176; &#47; <em>{options.weather.dat_high_temperature}</em>&#176; </span> </li> </ul> <div class="y-box city-select {show: !options.weather_show}"> <div class="y-box"> <div class="y-left select-style"> <p class="y-box"> <span class="y-left name">{options.current_province}</span> <span class="y-right y-icon icon-more" onclick="{showProvinces}"></span> </p> <div class="y-box province-list {show: options.province_show}"> <a class="y-left item" href="javascript:;" each="{item, i in options.locations}" onclick="{changeProvince}"> {item} </a> </div> </div> <div class="y-right select-style"> <p class="y-box"> <span class="y-left name">{options.current_city}</span> <span class="y-right y-icon icon-more" onclick="{showCities}"></span> </p> <div class="y-box city-list {show: options.city_show}"> <a class="y-left item" href="javascript:;" each="{item, i in options.cities}" onclick="{changeCity}"> {item} </a> </div> </div> </div> <div class="y-box action"> <a href="javascript:;" class="y-left ok-btn" onclick="{onSubmitClick}">确定</a> <a href="javascript:;" class="y-right cancel-btn" onclick="{onCancelClick}">取消</a> </div> </div>', 'class="y-weather"', function () {
    function t(t) {
        ...
        return t >= 0 && 50 >= t ? {
            ...
            c: i ? "#ff9f2d" : "#c58120",
            t: "中度污染"
        } : t >= 201 && 300 >= t ? {c: i ? "#ff5f5f" : "#cf3d3d", t: "重度污染"} : t >= 301 ? {
            c: i ? "#ff5f5f" : "#cf3d3d",
            t: "严重污染"
        } : {c: "rgba( 214, 117, 3, 0.8 )", t: "其他"}
    }
    ...
    this.options = {
        ...
        city_show: !1,
        weather_show: !0
    }, riot.observable(this), this.on("weatherChange", function (t) {
        this._renderWeather(t)
    }), this.init = function () {
        this._getCities()
    }.bind(this), this.showProvinces = function () {
        this.options.city_show = !1, this.options.province_show = !this.options.province_show
    }.bind(this), this.showCities = function () {
        this.options.province_show = !1, this.options.city_show = !this.options.city_show
    }.bind(this), this.changeLocation = function () {
        this.options.weather_show = !1
    }.bind(this), this.changeProvince = function (t) {
        this.options.city_show = !1, this.options.province_show = !1, this.options.current_province = t.item.item, this._renderCities(t.item.item)
    }.bind(this), this.changeCity = function (t) {
        this.options.city_show = !1, this.options.province_show = !1, this.options.current_city = t.item.item
    }.bind(this), this.onSubmitClick = function () {
        var t = this;
        this.options.weather_show = !0, this._getWeather({city: t.options.current_city})
    }.bind(this), this.onCancelClick = function () {
        this.options.weather_show = !0
    }.bind(this), this._getWeather = function (t) {
        var i = this;
        http({
            url: "/stream/widget/local_weather/data/", method: "GET", data: t, success: function (t) {
                t = t || {}, "success" === t.message && (i._renderWeather(t.data.weather), Cookies.set("WEATHER_CITY", t.data.city, {expires: 100}), i.parent && i.parent.trigger("weatherChange", t.data.weather))
            }
        })
    }.bind(this), this._renderWeather = function (i) {
        this.options.weather = i, this.options.city = i.city_name, this.options.wind = i.wind_direction + i.wind_level + "级", this.options.air = i.quality_level + " " + i.aqi, this.options.level = t(i.aqi).c, this.update()
    }.bind(this), this._getCities = function () {
        var t = this;
        http({
            url: "/stream/widget/local_weather/city/", method: "GET", success: function (i) {
                i = i || {}, "success" === i.message && (t.options.locations = i.data, t._renderCities(t.options.current_province))
            }
        })
    }.bind(this), this._renderCities = function (t) {
    ...
    this.options = {
        navItem: [{name: "推荐", url: "/", en: "recommend"}, {
            ...
            url: "/ch/news_hot/",
            en: "hot"
        }, {name: "视频", url: "/ch/video/", en: "video"}, {name: "图片", url: "/ch/news_image/", en: "image"}, {
            name: "段子",
            url: "/ch/essay_joke/",
            en: "essay"
            ...
            en: "entertainment"
        }, {name: "科技", url: "/ch/news_tech/", en: "tech"}, {name: "汽车", url: "/ch/news_car/", en: "car"}, {
            name: "体育",
            url: "/ch/news_sports/",
            en: "sports"
    ...
    function i(t) {
        (t >= 65 && 90 >= t || t >= 48 && 57 >= t || t >= 96 && 111 >= t || t >= 186 && 222 >= t || 8 == t || 46 == t || 32 == t || 13 == t) && (clearTimeout(n), n = setTimeout(function () {
            n = null, e(), s.update()
        }, 200)), s.update()
    }
    ...
    function e() {
        ...
        "" != t.trim() && http({
            url: "/search/sug/", data: {keyword: t}, method: "get", success: function (t) {
                "success" == t.message ? (s.options.suggestList = t.data, s.options.layershow = !0) : s.options.suggestList = [], s.options.isHotwords = !1, s.update()
            }
        })
    }
    ...
    }.bind(this), this._getHotWords = function () {
        http({
            url: "/hot_words/", method: "GET", success: function (t) {
                t = t.hot_words || t || [], _.isArray(t) && 0 !== t.length && (s.options.suggestList = o = t, s.options.isHotwords = !0, s.options.keyword = s.options.searchTip + t[0], s.update())
            }
        })
    }.bind(this), this.onKeyup = function (t) {
        "" == this.keyword.value.trim() ? (this.options.isHotwords = !0, this.options.suggestList = o) : i(t.keyCode)
    }.bind(this), this.onFocus = function () {
        this.inputbox.style["border-color"] = "#ed4040", this.options.keyword = "", this.options.layershow = !0
    }.bind(this), this.onBlur = function () {
        this.inputbox.style["border-color"] = "#e8e8e8", this.options.layershow = !1
    }.bind(this), this.onSearchClick = function () {
    ...
    }.bind(this), this.onSearchItemClick = function (t) {
        this.options.keyword = t.item.item, this.update(), this.searchForm.submit()
    }.bind(this);
    var n = null
    ...
    this.options = {city: "", state: "", top: 0, low: 0, userInfo: t.userInfo};
    var i = this.tags.weather;
    this.tags.userFeedback, this.init = function () {
        if (this.opts.home) {
            var t = Cookies.get("WEATHER_CITY") || "";
            this._getWeather({city: t})
        }
    }.bind(this), this._getWeather = function (t) {
        var e = this;
        http({
            url: "/stream/widget/local_weather/data/", method: "GET", data: t, success: function (t) {
                t = t || {}, "success" === t.message && (e._renderWeather(t.data.weather), i && i.trigger("weatherChange", t.data.weather))
            }
        })
    }.bind(this), this._renderWeather = function (t) {
        this.options.weather = t, this.options.city = t.city_name, this.options.state = t.current_condition, this.options.top = t.high_temperature, this.options.low = t.low_temperature, this.update()
    }.bind(this), this.init(), this.on("weatherChange", function (t) {
        this._renderWeather(t)
    }), this.on("mount", function () {
    ...
    var i = this;
    t.pageid, t.abtype, this.options = {
        id: t.userinfo.id,
    ...
    }.bind(this), window.on("userChange", function (t) {
        t && (i.options.id = t.user_id, i.options.name = t.name, i.options.avatarUrl = t.avatar_url, i._isPgc(), i.update())
    }), this._isPgc = function () {
        var t = this;
        http({
            url: "/user/pgc_info/", method: "get", cache: !1, success: function (i) {
                i = i || {}, "success" === i.message && i.data.is_pgc_author && (t.options.isPgc = !0, t.update())
            }
        })
    }.bind(this)
    ...
    var i = this;
    riot.observable(this), this.options = {
        hide: !0,
        errorMsg: "",
        captchaImg: ""
    }, this.curSpec = {
        ...
        this.options.hide = !0, this.update()
    }.bind(this), this.onFormSubmit = function (t) {
        t.preventDefault();
        var i = this, e = http.serialize(t.currentTarget);
        user.loginByLoc({
            data: e, successCb: function (t) {
                "function" == typeof i.curSpec.successCb && i.curSpec.successCb(t), i.hide()
            }, errorCb: function (t) {
                i.password.value = "", t = t || {};
                var e = t.data || {};
                i.options.errorMsg = e.description || "登录失败", e.captcha ? (i.captcha.value = "", i.options.captchaImg = "data:image/gif;base64," + e.captcha) : (i.captcha.value = "", i.options.captchaImg = ""), "function" == typeof i.curSpec.errorCb && i.curSpec.errorCb(t), i.update()
            }
        })
    }.bind(this), this.onSnsLoginClick = function (t) {
        var i = utils.getTarget(t),
            e = utils.getAttribute(i, "data-pid") || utils.getAttribute(i.parentNode, "data-pid");
        this.hide(), user.loginByOther(e, this.curSpec)
    }.bind(this), window.on("login", function (t) {
        i.options.hide = !1, t = t || {}, i.curSpec = {
            successCb: t.successCb || function () {
            }, errorCb: t.errorCb || function () {
            }
        }, i.update()
    ...
    var t = this;
    this.msg = "", this.disabled = !1, this.showMessage = function (t) {
        this.msg = this.message[t], this.update()
    }.bind(this), this.hide = function () {
        this.unmount(!0)
    }.bind(this), this.onFormSubmit = function () {
        var i = this["feedback-email"], e = this["feedback-content"];
        return i.value.length < 5 ? (i.focus(), this.showMessage("mail_error")) : "" === e.value ? (e.focus(), this.showMessage("content_error")) : (this.msg = "", this.disabled = !0, this.update(), void http({
            ...
            url: "/post_message/",
            method: "post",
            data: {appkey: "web", uuid: i.value, content: "[" + window.location.host + "]" + e.value},
            success: function (s) {
            ...
            error: function () {
                t.disabled = !1, t.update(), t.showMessage("fail")
            }
        }))
    }.bind(this)
    ...
    var t = this;
    this.on("mount", function () {
        var i = this.toast, e = i.clientWidth, s = i.clientHeight, o = new TAnimation;
        i.style.cssText += "margin-top:-" + s / 2 + "px;margin-left:-" + e / 2 + "px", o.animate({
            el: i,
            prop: "opacity",
            to: 0,
    ...
    var i = {};
    i.getHoney = function () {
        var t = Math.floor((new Date).getTime() / 1e3), i = t.toString(16).toUpperCase(),
    ...
    var i = this, e = t.number, s = (t.all, t.unit, Math.pow(10, 9)), o = Math.pow(10, 8), n = Math.pow(10, 7),
        a = Math.pow(10, 5), l = Math.pow(10, 4), r = Math.pow(10, 3);
    return i.flag = "", i.value = "", t.all && "true" == t.all ? (i.flag = "", void(i.value = t.number)) : void(e - s >= 0 ? (i.flag = "亿", i.value = Math.floor(e / o)) : e - o >= 0 ? (i.flag = "亿", i.value = (Number(Math.floor(e / n) / 10).toFixed(1) + "").replace(/\.0$/, "")) : e - a > 0 ? (i.flag = "万", i.value = Math.floor(e / l)) : e - l >= 0 ? (i.flag = "万", i.value = (Number(Math.floor(e / r) / 10).toFixed(1) + "").replace(/\.0$/, "")) : i.value = t.number)
    ...
    function i() {
        var t = document.title, i = "视频转码已完成，请查看 - 今日头条(www.toutiao.com)", s = !0;
        e.timer = setInterval(function () {
            s ? (document.title = i, s = !1) : (document.title = t, s = !0)
        }, 1e3)
    }

    var e = this, s = {pending: "您有一个进行中的任务", done: "视频转码完成，请查看"};
    this.bg_img = t.bg_img, this.avtar_img = t.avtar_img, this.abstract = t.abstract, this.popupStatus = s.pending, this.timer = null, "2" == t.right_knight_sign_status && (this.abstract += "2" == t.kbanquan_sign_status ? "（本头条号已经与维权骑士、快版权签约）" : "（本头条号已经与维权骑士签约）"), this.hangup = !1, window.on("uploadReady", function (t) {
        t.ready === !0 && "video" === t.type && (e.popupStatus = s.done, e.update(), i())
    }), this.showPublishPop = function () {
        this.hangup ? window.trigger("uploadShow", {type: e.type}) : riot.mount("ugcBox", {isShowImgTab: t.ugcContentUser})
    }.bind(this), window.on("uploadHide", function (t) {
        e.hangup = !0, e.type = t.type, e.update()
    }), window.on("uploadClose", function () {
        e.hangup = !1, e.popupStatus = s.pending, e.update(), clearInterval(e.timer), document.title = "今日头条(www.toutiao.com)"
    });
    ...
    var i = this, e = (t.abtype, {});
    i.page_type = "0", i.isSelf = userInfo.isOwner, i.on("update", function () {
        i.isArticle = "1" == t.page_type, i.isVideo = "0" == t.page_type, i.isFavourite = "2" == t.page_type, i.isWeiToutiao = "3" == t.page_type
            ...
            successCb: function () {
                ...
                window.trigger("login", {
                    successCb: function (e) {
                        window.trigger("userChange", e), i._dislike(t.item)
                    }
                })
            }
        })
    }.bind(this), this._dislike = function (e) {
        http({
            url: "/group/unrepin/",
            headers: {"X-CSRFToken": Cookies.get("csrftoken")},
            data: {group_id: e.item.group_id, item_id: e.item.item_id},
            method: "get",
            success: function (s) {
                "success" === s.message && (t.list.splice(e.i, 1), i.update(), riot.mount("#toast", "toast", {msg: "已取消收藏"}))
            },
            error: function () {
                riot.mount("#toast", "toast", {msg: "网络错误，请重试"})
            }
        })
    }.bind(this), this.onItemClick = function (t) {
        var i = t.item.item;
        return i.is_diversion_page && taAnalysis && taAnalysis.send("event", {ev: "diversion_page_click"}), !0
    }.bind(this), this.sourceFlag = function (t, i) {
        return (t = t.replace(/\s*/gi, "")) ? (void 0 === e[t] && (e[t] = i % 6), e[t]) : 0
    }.bind(this), this.sourceHandle = function (t) {
        return t = t.replace(/\s*/gi, ""), t ? t.slice(0, 1) : ""
    }.bind(this), this.deleteUgcVideo = function (t) {
        user.checkLogin({
            successCb: function () {
                ...
                window.trigger("login", {
                    successCb: function (e) {
                        window.trigger("userChange", e), i._removeVideo(t.item)
                    }
                })
            }
        })
    }.bind(this), this._removeVideo = function (e) {
        http({
            url: "/c/ugc/video/delete/",
            headers: {"X-CSRFToken": Cookies.get("csrftoken")},
            data: {item_id: e.item.item_id},
            method: "get",
            success: function (s) {
                "success" === s.message ? (t.list.splice(e.i, 1), i.update(), riot.mount("#toast", "toast", {msg: "已删除"})) : riot.mount("#toast", "toast", {msg: "删除失败"})
            },
            error: function () {
                riot.mount("#toast", "toast", {msg: "网络错误，请重试"})
            }
        })
    }.bind(this), this.deleteUgcItem = function (t) {
        user.checkLogin({
            successCb: function () {
                ...
                window.trigger("login", {
                    successCb: function (e) {
                        window.trigger("userChange", e), i._removeUgcItem(t.item)
                    }
                })
            }
        })
    }.bind(this), this._removeUgcItem = function (e) {
        http({
            url: "/c/ugc/content/delete/",
            headers: {"X-CSRFToken": Cookies.get("csrftoken")},
            data: {thread_id: e.item.thread_id},
            method: "POST",
            success: function (s) {
                "success" === s.message ? (t.list.splice(e.i, 1), i.update(), riot.mount("#toast", "toast", {msg: "已删除"})) : riot.mount("#toast", "toast", {msg: "删除失败"})
            },
    ...
    function e(i, e) {
        if (!t.isBanned && !u) {
            ...
            var s = o();
            http({
                url: d, method: "get", data: s, type: h, success: function (t) {
                    "success" === t.message && ("refresh" === i && (c.list = []), f == t.page_type && (c.list = c.list.concat(n(t.data)), m[1 * f] = !!t.has_more, a(), c.params.max_behot_time = t.next && t.next.max_behot_time || 0))
                }, complete: function () {
                    c.empty = 0 === c.list.length, u = !1, e && e(), c.update()
                }
            })
        }
    }
    ...
    function s(t) {
        if (!u) {
            u = !0;
            var i = o();
            i.max_repin_time = g, http({
                url: p, method: "get", data: i, type: h, success: function (t) {
                    "success" === t.message && (0 == g && (c.list = []), c.list = c.list.concat(n(t.data)), m[1 * f] = !!t.has_more, a(), g = t.max_repin_time || 0)
                }, complete: function () {
                    u = !1, t && t(), c.empty = 0 == c.list.length, c.update()
                }
            })
        }
    }
    ...
    function o() {
        ...
        return window.TAC && (e = TAC.sign(userInfo.id + "" + c.params.max_behot_time)), t = _.extend({}, c.params, {
            as: i.as,
            cp: i.cp,
            _signature: e
        })
    ...
    function n(t) {
        return _.map(t, function (t) {
            return t && t.go_detail_count && (t.go_detail_count = utils.numFormat(t.go_detail_count, 1)), t && t.detail_play_effective_count && (t.detail_play_effective_count = utils.numFormat(t.detail_play_effective_count, 1)), t
        })
    }

    function a() {
        for (var t, i, e = 0; e < c.list.length; e++) t = c.list[e], i = new Date(1e3 * t.behot_time), t.formattedDateTime = i.getFullYear() + "-" + l(i.getMonth() + 1) + "-" + l(i.getDate()) + " " + l(i.getHours()) + ":" + l(i.getMinutes())
    }
            ...
            0 !== v && (i = {max_time: v}), http({
                ...
                success: function (t) {
                    if ("success" === t.message) {
                        for (var i, e, s = t.data.list, o = 0; o < s.length; o++) i = s[o], e = new Date(1e3 * i.create_time), i.formattedDateTime = e.getFullYear() + "-" + l(e.getMonth() + 1) + "-" + l(e.getDate()) + " " + l(e.getHours()) + ":" + l(e.getMinutes()), i.read_count && (i.read_count = utils.numFormat(i.read_count, 1)), v = i.create_time;
                        c.list = c.list.concat(s), m[1 * f] = !!t.data.has_more
                    }
                },
                complete: function () {
                    u = !1, t && t(), c.empty = 0 == c.list.length, c.update()
    ...
    var c = this, u = !1, d = "/c/user/article/", p = "/c/user/favourite/", h = "json", m = [!0, !0, !0, !0], g = 0,
        f = "1", v = 0;
    c.list = [], c.empty = !1, this.options = {isRefresh: !1, isLoadmore: !1}, this.params = {
        page_type: "1",
        user_id: userInfo.id,
        max_behot_time: 0,
        count: 20
    }, this.on("mount", function () {
        window.trigger("tabChange", t.code), !t.group_id && utils.on(window, "scroll", _.throttle(function () {
            var i = utils.scrollTop(), e = c.feedbox.clientHeight, s = utils.offset(c.feedbox).top,
                o = window.screen.height;
            600 > e + s - i - o && (!m[1 * f] || c.empty || t.isBanned || c.loadMoreClick())
        }, 350))
    }), window.on("tabChange", function (s) {
        var o = "0";
        "a" == s && (o = "1"), "b" == s && (o = "0"), "c" == s && (o = "2"), "d" == s && (o = "3"), f = o, c.list = [], c.empty = !1, c.options.isRefresh = !1, c.options.isLoadmore = !1, c.params.page_type = o, c.params.max_behot_time = 0, v = 0, c.update(), t.isBanned || ("a" === s || "d" === s ? i() : "c" == s ? (g = 0, c.loadMoreClick()) : "b" == s && (c.options.isLoadmore = !0, c.update(), e("refresh", function () {
            c.options.isLoadmore = !1
        })))
    }), this.loadMoreClick = function () {
        c.options.isLoadmore = !0, c.update(), "0" == f || "1" == f ? e("loadmore", function () {
            c.options.isLoadmore = !1
        }) : "2" == f ? s(function () {
            c.options.isLoadmore = !1
        }) : "3" == f && r(function () {
    ...
    var i = this;
    this.text = t.txt, i.media_id = t.media_id;
    var e = t.like;
    this._updateStatus = function (e, s) {
        i.following = e && !s, i.each = e && s, i.following && (i.text = t.activetxt), i.each && (i.text = t.friendedtxt), !i.following && !i.each && (i.text = t.txt)
    }.bind(this), this._updateStatus(t.like, t.liked), this.getInfo = function () {
        var s = e ? "unfollow" : "follow", o = "/c/user/" + s + "/", n = "";
        ...
        var a = function () {
            http({
                ...
                url: o,
                method: "get",
                data: {user_id: i.media_id, _signature: n},
                success: function (o) {
                    return "success" !== o.message ? void riot.mount("#toast", "toast", {msg: o.message}) : (e = !e, "follow" == s ? (i._updateStatus(!0, t.liked), "list" == t.from && window.trigger("attentionChange", i.media_id, !0)) : (i._updateStatus(!1, t.liked), "list" == t.from && window.trigger("attentionChange", i.media_id, !1)), void i.update())
                }
            })
        };
        user.checkLogin({
    ...
    function i() {
        http({
            url: o, method: "get", data: {media_id: s}, success: function (t) {
                "success" === t.message && (e.list = _.map(t.data.hot_articles, function (t) {
                    return t && t.go_detail_count && (t.go_detail_count = utils.numFormat(t.go_detail_count, 1)), t
                }))
            }, complete: function () {
                e.show = e.list.length > 0, e.update(), e.show && riot.mount(".articles", {list: e.list})
            }
        })
    }

    var e = this, s = t.mediaId, o = "/api/pc/media_hot/";
    e.show = !1, e.list = [], t.isBanned || i()
    ...
    this.is_go = !1;
    var t = this, i = document.querySelector(".right"), e = i.getBoundingClientRect();
    e = e.left + e.width + 30, t.left = e;
    ...
    window.onscroll = _.throttle(function () {
        ...
        t.is_go = i > 0 ? !0 : !1, t.update()
    }, 100), this.go = function () {
        window.scroll(0, 0)
    }.bind(this)
    ...
    this.sendRequest = function (i) {
        var e = this, s = t.user_id, o = "/c/user/" + i + "/", n = function () {
            http({
                headers: {"X-CSRFToken": Cookies.get("csrftoken")},
                url: o,
                method: "post",
        ...
        user.checkLogin({
            successCb: function () {
                ...
                window.trigger("login", {
                    successCb: function (t) {
                        window.trigger("userChange", t), n()
                    }
                })
            }
        })
    }.bind(this), this.subscribe = function () {
        this.sendRequest("unfollow")
    }.bind(this), this.unsubscribe = function () {
    ...
    var i = {
        isOnline: function () {
            ...
            try {
                ...
                for (var e = 0, s = t.length, o = []; s > e; e++) o.push(t[e]);
                return o
            }
        }
    };
    ...
    function i(t, i, e) {
        this.uploader = t, this.file = i, this.status = 0, this.progress = 0, this.uploadedBytes = 0, this.useChunk = e.useChunk || !1, this.chunkSize = e.chunkSize || 0, uploadUtils.isFile(i) ? this._createFile(i) : this._createFileFromInput(i.value), this.useChunk = this.useChunk && this.size > this.chunkSize
    }

    var e = 1, s = 2, o = 3, n = 4, a = 5;
    i.prototype._createFileFromInput = function (t) {
        ...
        var t = this.uploadedBytes, i = t + this.chunkSize;
        return i > this.size && (i = this.size, this.chunkSize = i - this.uploadedBytes), {
            start: t,
            end: i,
        ...
        this.useChunk ? (this.uploadedBytes += this.chunkSize, this.uploadedBytes === this.size && (this.status = n)) : this.status = n
    ...
    function i(t) {
        ...
        this.fileQueue = [], this.isUploading = !1, this.options = {
            ...
            useChunk: !0,
            chunkSize: 10485760
        }, uploadUtils.extend(this.options, t), this.options.filters.push({
            name: "maxLimit", fn: function () {
    ...
    i.prototype.getAll = function () {
        ...
        for (var t = uploadUtils.isFileList(t) ? uploadUtils.toArray(t) : [t], i = 0, e = t.length; e > i; i++) {
            var s = t[i],
                o = new FileItem(this, s, {useChunk: this.options.useChunk, chunkSize: this.options.chunkSize});
            if (!this._filePreHandle(o, this.options.filters)) return !1;
            this.fileQueue.push(o)
        }
        return this.options.autoUpload, !0
        ...
        if (!this.isUploading) {
            var i = uploadUtils.isHTML5() ? "_xhrPost" : "_iframePost", t = t || this._getNotUploadedItems()[0];
            t && (this.isUploading = !0, t.onPrepareUpload(), this[i](t))
        }
        ...
        for (var e = 0, s = i.length; s > e; e++) {
            var o = i[e];
            if (!o.fn.call(this, t)) return o.fail && o.fail.call(this), !1
        }
        return !0
        ...
        return uploadUtils.isObject(t) ? null : (t.split("\n").forEach(function (t) {
            var e = t.indexOf(":");
            if (e > -1) {
                var s = t.slice(0, e).trim(), o = t.slice(e + 1).trim();
                i[s] = i[s] ? i[s] + "," + o : o
            }
        }), i)
    }, i.prototype._xhrPost = function (t) {
        var i = this, e = t._xhr = new XMLHttpRequest, s = new FormData;
        if (t.onBeforeUpload(), !uploadUtils.isEmptyObject(this.options.formData)) for (var o in this.options.formData) s.append(o, this.options.formData[o]);
        if (e.open(this.options.method, this.options.url, !0), e.responseType = this.options.responseType, e.withCredentials = this.options.withCredentials, !uploadUtils.isEmptyObject(this.options.headers)) for (var o in this.options.headers) e.setRequestHeader(o, this.options.headers[o]);
        if (t.useChunk) {
            var n = t.getChunkFile();
            s.append("file", n.file, t.name), e.setRequestHeader("Content-Range", "bytes " + n.start + "-" + (n.end - 1) + "/" + t.size)
        } else s.append("file", t.file, t.name), e.setRequestHeader("Content-Range", "bytes 0-" + (t.size - 1) + "/" + t.size);
        e.upload.onprogress = function (e) {
            var s = e.lengthComputable ? e.loaded : 0, o = e.lengthComputable ? e.total : -1;
            t.onProgress(s, o), i.options.progressCbk && i.options.progressCbk(t)
        }, e.onload = function () {
            var s = e.response, o = 200 == e.status ? "Success" : "Error", n = "_on" + o + "Upload";
            "Success" === o && (t.responseItem = s), i[n](t), i._onCompleteUpload(t)
        }, e.onerror = function () {
            i._onErrorUpload(t), i._onCompleteUpload(t)
        }, e.onabort = function () {
            i._onAbortUpload(t), i._onCompleteUpload(t)
        }, e.send(s)
    }, i.prototype._iframePost = function () {
    }, t.FileUpload = i
}(window, document), riot.tag("ugcBox", '<div class="ugcBox" show="{options.isShow}"> <div class="ugcBox-inner"> <ul class="y-box ugc-tab-list"> <li class="y-left ugc-tab-item {current: options.type === 1}" onclick="{changeType}" data-type="1" if="{opts.isShowImgTab}">发布图文</li> <li class="y-left ugc-tab-item {current: options.type === 2}" onclick="{changeType}" data-type="2">发布视频</li> </ul> <span class="ugc-close" onclick="{closeUploadClick}"> <span><i class="y-icon icon-dislikenewfeed"></i></span> </span> <div class="ugc-content"> <div if="{options.type === 1}" riot-tag="imgBox"></div> <div if="{options.type === 2}" riot-tag="videoBox"></div> </div> </div> </div>', function (t) {
    var i = this;
    this.options = {isShow: !0, isPending: !1, type: t.isShowImgTab ? 1 : 2}, this.changeType = function (t) {
        var i = 1 === this.options.type ? "图文" : "视频",
            e = 1 === this.options.type ? "video_tab_click" : "img_tab_click";
        return this.options.isPending && !window.confirm("是否放弃" + i + "发布？") ? !1 : (this.options.isPending = !1, this.options.type = +t.target.dataset.type || 1, this.update(), void(window.taAnalysis && taAnalysis.send("event", {ev: e})))
    }.bind(this), window.on("uploadPending", function () {
        i.options.isPending = !0
    }), window.on("publishSuccess", function () {
        i.options.isPending = !1
    }), this.closeUploadClick = function () {
        return this.options.isPending && !window.confirm("确认取消上传？") ? !1 : (this.options.isPending = !1, this.unmount(!0), void window.trigger("uploadClose"))
    }.bind(this), window.on("uploadHide", function () {
        i.options.isShow = !1, i.update()
    }), window.on("uploadShow", function (t) {
        i.options.isShow = !0, i.options.type = t.type, i.update()
    ...
    function t(t) {
        return t ? t.split("/").slice(-1)[0] : ""
    }

    var i = this, e = !1, s = !1, o = 0, n = {video_id: "", title: "", thumb_uri: "", thumb_source: 1};
    this.inputInvalid = !1, this.tooLong = !1, this.options = {autoUpload: !1, uploadReady: !1};
    var a = this.title, l = !1;
    a.addEventListener("compositionstart", function () {
        l = !0
    }), a.addEventListener("compositionend", function () {
        l = !1
    }), this.inputKeyup = function () {
        o = i.title.value.trim(), o = o.length, o > 30 && !l ? (this.inputInvalid = !0, this.tooLong = !0, this.update()) : (this.inputInvalid = !1, this.tooLong = !1, this.update()), this.options.uploadReady = "" != i.title.value.trim() && e && !this.inputInvalid
    }.bind(this), this.autoCheck = function () {
        this.options.autoUpload = !this.options.autoUpload
    }.bind(this), this.backendUpload = function () {
        window.trigger("uploadHide", {type: 2})
    }.bind(this), this.publishVideo = function () {
        return "" == this.title.value.trim() ? (this.inputInvalid = !0, !1) : void(this.options.uploadReady && !s && (s = !0, n.title = i.title.value.trim(), http({
            url: "/c/ugc/video/publish/",
            method: "post",
            data: n,
            success: function (t) {
                "success" == t.message ? (window.trigger("publishSuccess"), riot.mount("#toast", "toast", {msg: "发布成功，页面将在 3 秒后自动刷新"}), setTimeout(function () {
                    window.location.href = location.origin + location.pathname + "?tab=video"
                }, 3e3)) : "error" == t.message && (riot.mount("#toast", "toast", {msg: t.data || "发布失败，请重试"}), s = !1)
            },
            error: function (t) {
                riot.mount("#toast", "toast", {msg: t.data || "服务器开了点小差，请稍后再试"}), s = !1
            }
        }), window.taAnalysis && taAnalysis.send("event", {ev: "user_ugc_video_submit"})))
    }.bind(this), window.on("uploadReady", function (s) {
        e = s.ready, n.video_id = s.video_id, n.thumb_uri = t(s.thumb_uri), i.options.uploadReady = "" != i.title.value.trim() && e && !i.inputInvalid, i.update()
    }), window.on("uploadThumb", function (i) {
        n.thumb_source = 1, n.thumb_uri = t(i.thumb_uri)
    })
}), riot.tag("videoUploadBox", '<div class="videoUploadBox"> <div class="y-box upload-box" if="{options.isInitShow}"> <form name="fileElemHolder" style="display: none;"> <input id="fileElem" name="fileElem" type="file" onchange="{handleFile}" accept="video/mp4,video/x-m4v,video/*"> </form> <div class="y-left upload-cover upload-cover-add" onclick="{uploadActionClick}" ga_event="user_ugc_upload"></div> <div class="y-right upload-warning"> <span>支持绝大多数的视频格式，大小不超过250M，请勿上传反动色情等违法视频。</span> </div> </div> <div class="y-box upload-box" if="{!options.isInitShow}"> <div class="y-left upload-cover upload-cover-loading"> <img if="{options.poster}" riot-src="{options.poster}" alt=""> </div> <div class="y-right upload-info"> <h3>{options.title}</h3> <div style="font-size: 0px;"> <span if="{options.isTranscoding}" class="upload-status">转码中...</span> <span if="{!options.isTranscoding}" class="upload-status">{options.statusMsg}</span> <span if="{!options.isTranscoding}" class="upload-ctr" onclick="{onCtrClick}">{options.ctrMsg}</span> </div> <div class="progress"> <div class="progress-rate" riot-style="width: {options.progress}%;"></div> </div> </div> </div> <h3 class="poster-tips" if="{options.posters.length!=0}">请点击选择视频封面缩略图</h3> <ul class="y-box cover-list" if="{options.posters.length!=0}"> <li class="y-left cover-item {active: options.activePoster == i}" each="{item,i in options.posters}" onclick="{coverPickClick}"> <img riot-src="{item}" alt=""> <i class="y-icon icon-check" if="{options.activePoster == i}"></i> </li> </ul> <p class="upload-msg">{options.sugMsg}</p> </div>', function () {
    function t() {
        http({
            url: "/c/ugc/video/upload/", method: "get", success: function (t) {
                if ("success" === t.message) {
                    var e = t.data;
                    r = e.upload_id, i({url: e.upload_url, chunkSize: e.chunk_size})
                }
            }
        })
    }
    ...
    function i(t) {
        l = new FileUpload({
            url: t.url, chunk_size: t.chunk_size, filters: [{
                name: "acceptType", fn: function (t) {
                    var i = /video/;
                    return i.test(t.type)
                }, fail: function () {
                    riot.mount("#toast", "toast", {msg: "文件类型错误"})
                }
            }, {
                name: "size", fn: function (t) {
                    ...
                    riot.mount("#toast", "toast", {msg: "文件过大"})
                }
            }], progressCbk: function (t) {
                e(2), n.options.progress = t.progress, n.update()
            }, completeCbk: function (t) {
                console.log(t.status), e(t.status)
            }
        });
        var i = l.addToQueue(a);
        i ? (l.uploadAll(), n.update()) : (n.fileElemHolder.reset(), n.options.isInitShow = !0, n.update())
    }

    function e(t) {
        c = t, s(t), o(t), n.update()
    }

    function s(t) {
        n.options.statusMsg = u[t], n.options.ctrMsg = d[t], n.options.sugMsg = p[t]
    }

    function o(t) {
        function i() {
            e || (e = !0, http({
                url: "/c/ugc/video/upload_status/",
                method: "get",
                data: {upload_id: r},
                success: function (t) {
                    if ("success" == t.message) {
                        var i = t.data;
                        e = !1, console.log(i.status), 10 === i.status && (console.log((new Date).getTime() - s), n.options.poster = i.img, n.options.posters = i.real_posters.slice(0, 8), n.options.isTranscoding = !1, n.update(), window.trigger("uploadReady", {
                            ready: !0,
                            type: "video",
                            video_id: i.video_id,
                            thumb_uri: i.img
        ...
        if (4 === t) {
            n.options.isTranscoding = !0, n.update();
            var e = !1, s = (new Date).getTime();
            i();
    ...
    var n = this, a = [], l = null, r = 0, c = 0, u = {1: "准备中...", 2: "上传中", 3: "上传取消", 4: "上传成功", 5: "上传失败"},
        d = {1: "", 2: "取消上传", 3: "", 4: "重新上传", 5: "继续上传"},
        p = {1: "", 2: "当前状态点击后台运行，将在上传成功后提示发布视频", 3: "", 4: "发布后视频将出现在个人主页", 5: "视频无法上传，请检查网络环境"};
    this.options = {
        isInitShow: !0,
        title: "",
        statusMsg: "准备中...",
        ...
        this.fileElem.click()
    }.bind(this), this.handleFile = function () {
        this.options.isInitShow = !1, this.update(), a = this.fileElem.files, a.length && (this.options.title = a[0].name, window.trigger("uploadReady", {
            ready: !1,
            type: "video"
        }), this.options.poster = "", this.options.posters = [], window.trigger("uploadPending"), t())
    }.bind(this), this.onCtrClick = function () {
        var t = l.getAll()[0];
        t && (2 === c ? window.confirm("确定取消咩") && (t.cancel(), this.fileElemHolder.reset(), this.options.isInitShow = !0, this.update()) : 4 === c ? (this.fileElemHolder.reset(), this.fileElem.click()) : 5 === c && l.uploadContinue(t))
    }.bind(this), this.coverPickClick = function (t) {
        this.options.activePoster = t.item.i, this.options.poster = t.item.item, window.trigger("uploadThumb", {thumb_uri: t.item.item})
    ...
    var t = this, i = !1, e = !1, s = 0, o = [], n = {content: "", image_uris: ""};
    this.inputInvalid = !1, this.tooLong = !1, this.options = {autoUpload: !1, uploadReady: !1};
    var a = this.title, l = !1;
    a.addEventListener("compositionstart", function () {
        l = !0
        ...
        s = t.title.value.trim(), s = s.length, s > 2e3 && !l ? (this.inputInvalid = !0, this.tooLong = !0, this.update()) : (this.inputInvalid = !1, this.tooLong = !1, this.update()), this.options.uploadReady = "" != t.title.value.trim() && i && !this.inputInvalid
    }.bind(this), this.autoCheck = function () {
        this.options.autoUpload = !this.options.autoUpload
    }.bind(this), this.backendUpload = function () {
        window.trigger("uploadHide", {type: 1})
    }.bind(this), this.publishImg = function () {
        if ("" == this.title.value.trim()) return this.inputInvalid = !0, !1;
        if (this.options.uploadReady && !e) {
            if (o.length > 9) return riot.mount("#toast", "toast", {msg: "图片不能多于 9 张"}), !1;
            e = !0, n.content = t.title.value.trim(), n.image_uris = o.join(","), http({
                url: "/c/ugc/content/publish/",
                method: "post",
                data: n,
                success: function (t) {
                    "success" == t.message ? (window.trigger("publishSuccess"), riot.mount("#toast", "toast", {msg: "发布成功，页面将自动刷新"}), setTimeout(function () {
                        window.location.href = location.origin + location.pathname + "?tab=weitoutiao"
                    }, 1e3)) : "error" == t.message && (riot.mount("#toast", "toast", {msg: t.data || "发布失败，请重试"}), e = !1)
                },
                error: function (t) {
                    riot.mount("#toast", "toast", {msg: t.data || "服务器开了点小差，请稍后再试"}), e = !1
                }
            }), window.taAnalysis && taAnalysis.send("event", {ev: "user_ugc_img_submit"})
        }
    }.bind(this), window.on("removeImg", function (t) {
        o.splice(t.i, 1)
    }), window.on("uploadReady", function (e) {
        i = e.ready, e.uri && o.push(e.uri), t.options.uploadReady = "" != t.title.value.trim() && i && !t.inputInvalid, t.update()
    })
    ...
    function t() {
        s = new FileUpload({
            url: "/c/ugc/image/upload/", filters: [{
                name: "acceptType", fn: function (t) {
                    var i = /image/;
                    return i.test(t.type)
                }, fail: function () {
                ...
                name: "size", fn: function (t) {
                    ...
                    riot.mount("#toast", "toast", {msg: "图片大小超过10M，请更换图片"})
                }
            }], progressCbk: function () {
            }, completeCbk: function (t) {
                i.options.loadingList.pop(), t && t.responseItem && t.responseItem.data && t.responseItem.data.url_list && (i.options.imgList.push(t.responseItem.data.url_list[0].url), i.update(), window.trigger("uploadReady", {
                    ready: !0,
                    type: "img",
                    uri: t.responseItem.data.web_uri
                }))
            }, errorCbk: function () {
                riot.mount("#toast", "toast", {msg: "上传失败，请更换图片再试试"}), window.trigger("uploadReady", {
                    ready: !0,
                    type: "img"
                })
            }
        ...
        t ? (s.uploadAll(), i.update()) : (i.fileElemHolder.reset(), i.update())
    }
    ...
    this.options = {
        ...
        window.trigger("removeImg", {i: t.item.i}), this.options.imgList = _.without(this.options.imgList, t.item.url), this.update()
    }.bind(this), this.uploadActionClick = function () {
        this.fileElem.click()
    }.bind(this), this.handleFile = function () {
        if (this.update(), e = this.fileElem.files, e.length) {
            window.trigger("uploadReady", {ready: !1, type: "img"}), window.trigger("uploadPending");
            for (var i = e.length - 1; i >= 0; i--) this.options.loadingList.push(i);
            t()
        }
    }.bind(this)
}), Function(function (t) {
...
https://www.toutiao.com/api/pc/feed/?max_behot_time=1525017316&category=__all__&utm_source=toutiao&widen=1&tadrequire=true&&_signature=ZRC53AAAP.naZkg6.RkZx2UQuc
