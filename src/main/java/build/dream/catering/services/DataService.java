...
public class DataService {
    ...
    public void saveDietOrder(String dietOrderData) {
        ...
        try {
            ...
            boolean isNotExists = CommonRedisUtils.setnx(signature, signature);
            if (!isNotExists) {
                return;
            }

            CommonRedisUtils.expire(signature, 30, TimeUnit.DAYS);
            ...
            dietOrderGroups.forEach(dietOrderGroup -> {
            ...
            dietOrderDetails.forEach(dietOrderDetail -> {
            ...
            dietOrderPayments.forEach(dietOrderPayment -> dietOrderPayment.setDietOrderId(dietOrderId));
            ...
            if (StringUtils.isNotBlank(dietOrderDetailGoodsAttributesJson)) {
                ...
                dietOrderDetailGoodsAttributes.forEach(dietOrderDetailGoodsAttribute -> {
            ...
            CommonRedisUtils.del(signature);
            throw e;
        }
    }
}
